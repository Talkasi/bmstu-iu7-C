...
Вывести на экран до пятого знака после запятой с обязательной распечаткой знака значение функции f(x)=cos(arcsin(x)) в
той же точке. Значения x и eps принимаются с клавиатуры.
*/
